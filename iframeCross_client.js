...
IframePostMessage.prototype._destory = function (callback) {
    var node = document.getElementById('talkfun_connector')
    if (node) {
...
IframePostMessage.prototype.destory = function (cb) {
    this._destory(cb)
}
